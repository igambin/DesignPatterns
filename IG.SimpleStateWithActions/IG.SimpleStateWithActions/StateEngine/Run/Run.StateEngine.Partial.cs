...
namespace IG.SimpleStateWithActions.StateEngine
{
    ...
    /// </summary>
    public class RunStateEngine : RunStateEngineBase
    {
        ...
        protected override async Task<bool> StartRun(Run run)
        {
            /* add logic here */
            await Task.Delay(0).ConfigureAwait(false);
            return true;
        }
        protected override async Task<bool> FinalizeRun(Run run)
        {
            /* add logic here */
            await Task.Delay(0).ConfigureAwait(false);
            return true;
        }
        protected override async Task<bool> StartCleanup(Run run)
        {
            /* add logic here */
            await Task.Delay(0).ConfigureAwait(false);
            return true;
